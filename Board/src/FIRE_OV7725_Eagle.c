...
{
    //寄存器，寄存器值次
    {OV7725_COM4         , 0x61},//0xC1
    {OV7725_CLKRC        , 0x00},
    {OV7725_COM2         , 0x03},
    {OV7725_COM3         , 0xD0},
    {OV7725_COM7         , 0x40},
    {OV7725_COM9         , 0x2a},//agc 3a = 16  2a ==8 1a =4
    {OV7725_HSTART       , 0x3F},
    {OV7725_HSIZE        , 0x50},
    {OV7725_VSTRT        , 0x03},
    {OV7725_VSIZE        , 0x78},
    ...
    {OV7725_SDE          , 0x04},
    //{OV7725_AEC          , 0xff},
    {OV7725_BRIGHT       , 0x0},// 0x0
    {OV7725_CNST         , 0x10},//0x10
    {OV7725_SIGN         , 0x06},
    {OV7725_UVADJ0       , 0x11},
    {OV7725_UVADJ1       , 0x02},
